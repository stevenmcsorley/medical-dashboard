...
const SimpleBarChart: React.FC<SimpleBarChartProps> = ({ sortType }) => {
  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <BarChart data={sortedData} margin={{ top: 10, right: 30, left: 30, bottom: 20 }}>
      <CartesianGrid strokeDasharray="1 0" strokeOpacity={0.3} vertical={false} />
        ...
        <Tooltip />
        <Bar dataKey="uv" fill="var(--color-green-brand)" />
      </BarChart>
    </ResponsiveContainer>
  );
};
